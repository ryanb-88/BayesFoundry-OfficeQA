...
## Overview
This skill provides guidance and performing complex numerical calculations in Python, such as:
...
## Key Capabilities
- Time series analysis: HP filter, moving averages,- Statistical summaries: mean, std, variance,- Unit conversions: handle various formats (thousands, millions, billions)
